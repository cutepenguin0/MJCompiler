...
public class OptionalActParsListDerived1 extends OptionalActParsList {

    private OptionalActPars OptionalActPars;

    public OptionalActParsListDerived1 (OptionalActPars OptionalActPars) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("OptionalActParsListDerived1(\n");
