...
public class DesignatorStmtListDerived1 extends DesignatorStmtList {

    private DesignatorStatementList DesignatorStatementList;

    public DesignatorStmtListDerived1 (DesignatorStatementList DesignatorStatementList) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesignatorStmtListDerived1(\n");
