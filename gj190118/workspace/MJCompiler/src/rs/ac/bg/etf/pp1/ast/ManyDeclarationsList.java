...
public class ManyDeclarationsList extends DeclarationsList {

    private DeclarationsList DeclarationsList;
    private Declaration Declaration;

    public ManyDeclarationsList (DeclarationsList DeclarationsList, Declaration Declaration) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ManyDeclarationsList(\n");
