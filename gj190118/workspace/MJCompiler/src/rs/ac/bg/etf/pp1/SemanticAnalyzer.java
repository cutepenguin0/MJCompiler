...
// ------------------- RETURN STATEMENT -----------------------
	...
	public void visit(MaxCalc maxCalc) {
		if(maxCalc.getDesignator().obj.getType().getElemType().getKind() == Struct.Array){
			report_info("U pitanju je matrica",maxCalc);
			maxCalc.struct = Tab.intType;
		}
	}
	...
	public void visit(Assignment designatorStatementDecl) {
