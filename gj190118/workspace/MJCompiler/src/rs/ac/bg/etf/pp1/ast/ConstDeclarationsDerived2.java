...
public class ConstDeclarationsDerived2 extends ConstDeclarations {

    private ConstDeclarations ConstDeclarations;
    private ConstDecl ConstDecl;

    public ConstDeclarationsDerived2 (ConstDeclarations ConstDeclarations, ConstDecl ConstDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ConstDeclarationsDerived2(\n");
